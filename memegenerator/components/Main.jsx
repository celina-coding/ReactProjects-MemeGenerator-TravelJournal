...
export default function Main() {
    ...
    const [memesArray, setMmemesArray] = useState([])
    
    useEffect(() => {
        fetch("https://api.imgflip.com/get_memes")
         .then(res => res.json())
         .then(data =>  setMmemesArray(data.data.memes) )
    }, [])
    
    console.log(memesArray)
    
    function handleFlipMeme(){
        console.log("meme flipped")
    ...
    return (
        <main>
            <div className="form">
                ...
                <button onClick={handleFlipMeme}>Get a new meme image 🖼</button>
            </div>
            <div className="meme">
